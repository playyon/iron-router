...
Route.prototype = {
  ...
  params: function (path) {
    ...
    queryString = ~queryStringIndex ? path.slice(queryStringIndex + 1) : null;
    if (queryString) {
      var hashIndex = queryString.indexOf('#');
      queryString = ~hashIndex ? queryString.slice(0, hashIndex) : queryString;
    }

    var hashIndex = path.indexOf('#');
    params.hash = ~hashIndex ? path.slice(0, hashIndex) : null;
